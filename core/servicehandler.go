...
func handleJoin(event *irc.Event) {
	...
	serviceLogger.Log(logging.Info, "[JOIN] %+v", event)
...
func handleQuit(event *irc.Event) {
	...
	serviceLogger.Log(logging.Info, "[QUIT] %+v", event)
...
func handlePart(event *irc.Event) {
	...
	serviceLogger.Log(logging.Info, "[PART] %+v", event)
...
func handleNick(event *irc.Event) {
	...
	serviceLogger.Log(logging.Info, "[NICK] %+v", event)
...
func handleNamesContinued(event *irc.Event) {
	...
	//rest are users
	serviceLogger.Log(logging.Info, "[NAMES] %+v", event)
...
func handleNamesEnd(event *irc.Event) {
	...
	serviceLogger.Log(logging.Info, "[NAMES-END] %+v", event)
